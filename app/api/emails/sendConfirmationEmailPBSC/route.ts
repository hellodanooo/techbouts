    ...
    <html>
        <body>
            ...
            <p><b>You must Review All Rules Prior to Competition</b><br><br>
             <a href="https://www.pointboxing.com/rules" style="background-color: transparent; color: black; text-decoration: none; border: 2px solid black; padding: 10px 20px; display: inline-block; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; margin: auto;">competition rules</a>
            </p>
